...
<div id='basic_search'>
    ...
    <form action="tasks.php" method="get" onsubmit="javascript:
        ...
        <div class="attached input">
            <input type="text" class="basic-search" placeholder="Search tasks" data-url="ajax.php/tasks/lookup" name="query"
...
<div style="margin-bottom:20px; padding-top:25px;">
    ...
    <form action="tasks.php" method="POST" name='tasks' id="tasks">
        ...
        <table class="list" id="scpTable" border="0" cellspacing="1" cellpadding="2" width="940">
            <thead>
                <tr>
